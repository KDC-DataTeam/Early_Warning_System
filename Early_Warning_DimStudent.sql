...
COALESCE(RE.RETAINED,0) AS EVER_RETAINED,
...
PS.GENDER,
CASE 
	WHEN PS.ENTRYCODE != '1800' AND PS.ENTRYCODE NOT IN ('PR','RE','DE','KIPP','1810','1811') THEN 1 --NEW TO KIPP
	WHEN PS.ENTRYCODE IS NULL THEN -1 --MISSING ENTRY CODE
	WHEN PS.ENTRYCODE = '1800' THEN -2 --STUDENT NEVER REACHED STAGE 5 ENROLLMENT
	ELSE 0 
END AS NEW_TO_KIPP
